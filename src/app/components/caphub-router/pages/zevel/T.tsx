    ...
    <div>
      ...
      <div className="terms">
        ...
        <p>
          ...
          our copyright agent via email at legal@CapHub.ai and include in Your
        ...
        <p>
          You can contact our copyright agent via email at legal@CapHub.ai. Upon
        ...
        <ul>
          <li>
            <p>By email: service@CapHub.ai</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:
              <a
                href="Https://www.CapHub.ai"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.CapHub.ai
